...
export default function SolvePage({ params }: PageProps) {
    ...
    if (status === 'finished') {
        ...
        return (
            <div className="h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950 overflow-y-auto transition-all duration-500 custom-scrollbar">
